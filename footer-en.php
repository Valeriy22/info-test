                ...
                <div class="row">
                    <div class="col-md-6 col-sm-12">
                        <div class="footer-logo__wrapper">
                            ...
                            <span class="footer-descr"><?php the_field('footer_сopyright', 'option') ?></span>
                        </div>
                    </div>
                    <div class="col-md-6 col-sm-12">
                        <?php
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <p class="footer-address">
                            <?php the_field('footer_contacts_ua_address', 'option') ?>
                        </p>
                        <span class="footer-subheader"><?php echo get_field('footer_contacts_ua_phones', 'option')['footer_contacts_ua_phones_title'] ?></span>
                        <?php 
                            $phones_ua = get_field('footer_contacts_ua_phones', 'option')['footer_contacts_ua_phones_items'];
                            if($phones_ua){
                                foreach($phones_ua as $phone){ ?>
                                    <a class="footer-phone" href="tel:<?php echo $phone['footer_contacts_ua_phones_item'] ?>"><?php echo $phone['footer_contacts_ua_phones_item'] ?></a>
                        <?php
                                }
                            }
                        ?>
